function findCountry(subject,text) {
 var array= [
    {
        "num_code": "4",
        "alpha_2_code": "AF",
...
if(subject.indexOf(" " + array[i]['nationality'].toLowerCase())  > -1){
return array[i]['en_short_name'];
}

if(subject.indexOf(" " + array[i]['en_short_name'].toLowerCase() ) > -1){
return array[i]['en_short_name'];
}
...
if(text.indexOf(" " + array[i]['nationality'].toLowerCase())  > -1){
return array[i]['en_short_name'];
}

if(text.indexOf(" " + array[i]['en_short_name'].toLowerCase())  > -1){
return array[i]['en_short_name'];
}
